...
![Distribution of the locked 200-method screening results and fold-specific nested inner selections](./results/figures/FIGURE_3_RANGE_SPECIFIC_ERROR.png.png)
